...
public class PokerHand {
    ...
    private List<Integer> rankValues; // tie-breaker values
    ...
    private void evaluate() {
        ...
        for(int i=0;i<uniqueRanks.size()-1;i++){
            ...
            if(consecutive>=5) straightHigh=uniqueRanks.get(i-3); // high card of straight
        }
        ...
        if(isStraight && isFlush){
            // check if flush contains straight
